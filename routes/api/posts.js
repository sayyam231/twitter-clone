...
router.get('/', async function (req, res) {
    ...
    const posts = await findAndPopulate({ postedBy: { $in: list } });
    if (posts === null) {
        res.sendStatus(400);
    }
    else {
...
// **** Get Request: /api/posts/search/value ****
...
// **** Get Request: /api/posts/id/posts ****
...
// **** Get Request: /api/posts/id/replies ****
...
// **** Patch Request (Like): /api/posts/id/like ****
...
// **** Patch Request (Retweet): /api/posts/id/retweet ****
...
// **** Patch Request (Retweet): /api/posts/id ****
...
// **** Patch Request (Pin): /api/posts/id ****
